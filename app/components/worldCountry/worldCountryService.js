    ...
    class World {
        ...
        init () {
            ...
            countries.forEach((countryData) => {
                ...
                } else { // If player is not controlling a country, we can create AI from that countryData...
        ...
        getCountryStrength (countryCode) {
            ...
            const filterConqueredCountries = playerService.conqueredCountries.filter(country => country.countryCode === countryCode)[0];

            if (filterConqueredCountries !== undefined) return playerService.military.getTotalStrength();
